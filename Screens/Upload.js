    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.imagePicker} onPress={selectHeaderFile}>
        <View style={styles.imagePreviewContainer}>
          {headerImage ? (
            <Image source={{ uri: headerImageURI }} style={styles.previewImage} />
          ) : 
          <Image source={require("../assets/download1.png")} style={styles.previewImage} />}
        </View>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.imagePicker} onPress={selectFooterFile}>
        <View style={styles.imagePreviewContainer}>
          {footerImage ? (
            <Image source={{ uri: footerImageURI }} style={styles.previewImage} />
          ) : <Image source={require("../assets/download1.png")} style={styles.previewImage} />}
        </View>
      </TouchableOpacity>
      ...
      {success && <Text style={styles.successMessage}>Uploaded Successfully</Text>}
